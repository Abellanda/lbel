...
if ( ! class_exists( 'site_Comments' ) ) :
	class site_Comments extends Walker_Comment {
	 ...
	 * start_lvl() only goes as high as 1 deep nested comments */
		function __construct() { ?>
			...
			<h3><?php comments_number( __( 'No Responses to', 'site' ), __( 'One Response to', 'site' ), __( '% Responses to', 'site' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
			...
			<header class="comment-author">
				...
				<section id="comment-content-<?php comment_ID(); ?>" class="comment">
					<?php if ( ! $comment->comment_approved ) : ?>
							<div class="notice">
					<p class="bottom"><?php _e( 'Your comment is awaiting moderation.', 'site' ); ?></p>
				</div>
